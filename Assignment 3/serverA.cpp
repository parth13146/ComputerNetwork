...
int main(void){
    ...
    while(1){
        ...
        cout << "Server A has received a request for "<< buf<< endl;

        cout << "Server A found "<< returnCitiesCount(state_city,buf) <<" distinct cities for "<< buf << endl;
